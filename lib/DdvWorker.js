...
class DdvWorker extends domain.Domain{
	...
	defineGetter(){
		let args = p.argsToArray(arguments), _this = this;
			if(args.length===3){
...
const each = function each( obj, callback, args, this_obj ) {
